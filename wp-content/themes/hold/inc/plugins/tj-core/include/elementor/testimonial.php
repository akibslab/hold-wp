   ...
   protected function register_controls() {
      ...
      $this->add_control(
         ...
         [
            ...
            'default' => [
               [
                  'reviewer_title' => esc_html__('Christine Bürgler / Projektmanagerin', 'tjcore'),
                  ...
                  Koordination top einsetzen. Der Job ist nicht nur spannend, sondern lässt mir genug Energie, um
